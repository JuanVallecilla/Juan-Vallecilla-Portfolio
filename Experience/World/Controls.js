    ...
    this.scroll.add(
      ...
      (context) => {
        ...
        if (isDesktop) {
          ...
          // console.log(this.camera.orthographicCamera.position.z);
          //FINAL SHOOT----------------------------------------------------------
          // const vector = new THREE.Vector3();
          // this.camera.orthographicCamera.rotateX(0.2);
          // this.camera.orthographicCamera.rotateY(-0.1); //Math.PI / 4
          // this.camera.orthographicCamera.rotateZ(-0.03);
          // this.camera.orthographicCamera.position.y = 0;
          // this.camera.orthographicCamera.position.z = 0;
          // this.camera.orthographicCamera.position.x = 0;
          // this.camera.orthographicCamera.zoom = 4;
          //FINAL SHOOT----------------------------------------------------------

          // console.log(this.camera.orthographicCamera.getWorldDirection(vector));

          // this.actualRoom.position.set(0, 0, 0);
          // roomLights.lampLight.intensity = 0;
          // roomLights.lavaLight.intensity = 0;
          // console.log(this.camera.orthographicCamera.rotation);
          // this.camera.orthographicCamera.updateProjectionMatrix();
          // this.camera.orthographicCamera.updateMatrix();
          // this.camera.orthographicCamera.updateMatrixWorld();
          // this.camera.orthographicCamera.updateWorldMatrix();
